...
import { getWebRemoteIpcBridge, installWebRemoteIpcCapture, type IpcMainCaptureTarget, type WebRemoteIpcBridge } from './web-remote-ipc'
...
export function prepareWebRemoteFullUi(
  ...
  return getWebRemoteIpcBridge() ?? installWebRemoteIpcCapture(ipcMain)
}
